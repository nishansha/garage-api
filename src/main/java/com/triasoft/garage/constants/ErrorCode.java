...
public class ErrorCode {
    ...
    public enum Business implements Errors {
        ...
        WAREHOUSE_NOT_FOUND("BUS_173", "Warehouse not found"),
        WAREHOUSE_CODE_EXISTS("BUS_174", "A warehouse with this code already exists"),
        WAREHOUSE_IN_USE("BUS_175", "This warehouse has inventory assigned and cannot be deleted"),
